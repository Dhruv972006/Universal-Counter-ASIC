module universal_counter (VGND,
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_4_55 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_6 FILLER_0_4_6 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_31 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__and4_1 _30_ (.A(net11),
    .B(net10),
    .C(net9),
    .D(net8),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_06_));
 sky130_fd_sc_hd__nor4_1 _31_ (.A(net11),
    .B(net10),
    .C(net9),
    .D(net8),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_07_));
 sky130_fd_sc_hd__and2b_1 _32_ (.A_N(net12),
    .B(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_08_));
 sky130_fd_sc_hd__a21o_1 _33_ (.A1(net12),
    .A2(_06_),
    .B1(_08_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(net14));
 sky130_fd_sc_hd__inv_2 _34_ (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_09_));
 sky130_fd_sc_hd__nand2_1 _35_ (.A(_09_),
    .B(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_10_));
 sky130_fd_sc_hd__nor2_1 _36_ (.A(net7),
    .B(_10_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_11_));
 sky130_fd_sc_hd__and2_1 _37_ (.A(_08_),
    .B(_11_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 _38_ (.A(_12_),
    ...
    .VPWR(VPWR),
    .X(_00_));
 sky130_fd_sc_hd__or3b_1 _39_ (.A(net2),
    .B(net1),
    .C_N(net9),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_13_));
 sky130_fd_sc_hd__o2bb2a_1 _40_ (.A1_N(net2),
    .A2_N(net3),
    .B1(_10_),
    .B2(net9),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_14_));
 sky130_fd_sc_hd__a21oi_1 _41_ (.A1(_13_),
    .A2(_14_),
    .B1(net7),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_01_));
 sky130_fd_sc_hd__inv_2 _42_ (.A(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _44_ (.A(net10),
    ...
    .VPWR(VPWR),
    .Y(_17_));
 sky130_fd_sc_hd__and3_1 _45_ (.A(net8),
    .B(_16_),
    .C(_17_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_18_));
 sky130_fd_sc_hd__a21oi_1 _46_ (.A1(_16_),
    .A2(_17_),
    .B1(net8),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_19_));
 sky130_fd_sc_hd__o32a_1 _47_ (.A1(_10_),
    .A2(_18_),
    .A3(_19_),
    .B1(net4),
    .B2(_09_),
    ...
    .VPWR(VPWR),
    .X(_20_));
 sky130_fd_sc_hd__o311a_1 _48_ (.A1(net17),
    .A2(net2),
    .A3(net1),
    .B1(_15_),
    .C1(_20_),
    ...
    .VPWR(VPWR),
    .X(_02_));
 sky130_fd_sc_hd__xor2_1 _49_ (.A(net11),
    .B(_17_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _50_ (.A(_19_),
    ...
    .VPWR(VPWR),
    .Y(_22_));
 sky130_fd_sc_hd__or3_1 _51_ (.A(net11),
    .B(net2),
    .C(net1),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_23_));
 sky130_fd_sc_hd__o21a_1 _52_ (.A1(_09_),
    .A2(net5),
    .B1(_23_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_24_));
 sky130_fd_sc_hd__o211a_1 _53_ (.A1(_10_),
    .A2(_22_),
    .B1(_24_),
    .C1(_15_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_03_));
 sky130_fd_sc_hd__o21ai_1 _54_ (.A1(net16),
    .A2(_06_),
    .B1(net12),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_25_));
 sky130_fd_sc_hd__or3_1 _55_ (.A(net12),
    .B(_07_),
    .C(_06_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _56_ (.A(_09_),
    ...
    .VPWR(VPWR),
    .X(_27_));
 sky130_fd_sc_hd__a32o_1 _57_ (.A1(_09_),
    .A2(_25_),
    .A3(_26_),
    .B1(_27_),
    .B2(_10_),
    ...
    .VPWR(VPWR),
    .X(_28_));
 sky130_fd_sc_hd__o311a_1 _58_ (.A1(net12),
    .A2(net2),
    .A3(net1),
    .B1(_15_),
    .C1(_28_),
    ...
    .VPWR(VPWR),
    .X(_04_));
 sky130_fd_sc_hd__and3_1 _59_ (.A(net12),
    .B(_06_),
    .C(_11_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_2 input2 (.A(load),
    ...
    .VPWR(VPWR),
    .X(net2));
 sky130_fd_sc_hd__clkbuf_1 input3 (.A(load_data[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net3));
 sky130_fd_sc_hd__clkbuf_1 input4 (.A(load_data[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net4));
 sky130_fd_sc_hd__clkbuf_1 input5 (.A(load_data[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net5));
 sky130_fd_sc_hd__clkbuf_1 input6 (.A(load_data[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_1 input7 (.A(reset),
    ...
    .VPWR(VPWR),
    .X(net7));
 sky130_fd_sc_hd__buf_1 input8 (.A(up_down),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net8));
 sky130_fd_sc_hd__clkbuf_1 max_cap16 (.A(_07_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
